...
const icons: Record<string, React.ReactNode> = {
  ...
  feedback: (
    <path d="M4 4.5h16v11H8.5L4 19V4.5z" strokeLinecap="round" strokeLinejoin="round" />
  ),
  engagement: (
    <>
            ...
            'children' in item && item.children ? (
              <div key={item.label} className="group relative">
                ...
                <div className="invisible absolute top-full left-1/2 -translate-x-1/2 pt-3 opacity-0 transition-all duration-150 group-hover:visible group-hover:opacity-100">
                  <motion.div
                    initial={false}
                    className="w-80 rounded-2xl border border-ink/10 bg-white p-2 shadow-[0_20px_60px_-20px_rgba(58,33,206,0.35)]"
                  >
