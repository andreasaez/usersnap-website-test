  ...
  items: [
    {
      ...
      body: 'Every support ticket, sales note, and in-app comment connects automatically, tagged back to its source the moment it appears. Your team sees the full pattern without pulling exports or waiting on a synthesis pass.',
      href: '#',
    },
    {
      title: 'Roadmaps',
      body: 'Every roadmap item links back to the evidence that shaped it and the outcome it is meant to drive. That reasoning stays attached from the start, so reviews turn into a walkthrough of proof leadership already trusts.',
      href: '#',
    },
    {
      title: 'Integrations & Workflows',
      body: 'Usersnap connects automatically to the tools already in your stack, including support, sales, analytics, and MCP-enabled AI, so signal flows without manual exports or one-off syncs. Your workflow stays exactly where it is.',
      href: '#',
    },
  ],
}
